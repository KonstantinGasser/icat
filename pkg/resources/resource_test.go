...
func TestGet(t *testing.T) {
	...
	tt := []struct {
		...
		{kind: NetConnHTTP{}, src: "http://:pass@example.org:123/some/directory/file.html?query=string#fragment", excpected: "http://:pass@example.org:123/some/directory/file.html?query=string#fragment"},
		{kind: NetConnHTTP{}, src: "http://[2010:836B:4179::836B:4179]", excpected: "http://[2010:836B:4179::836B:4179]"},
		{kind: NetConnHTTP{}, src: "http://i.xss.com\\www.example.org/some/directory/file.html?query=string#fragment", excpected: "http://i.xss.com\\www.example.org/some/directory/file.html?query=string#fragment"},
	}
